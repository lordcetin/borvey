...
const SidebarAdmin = (props: Props) => {
  ...
  const menu:any[] = [
    {title:'Kullanıcılar',link:`/admin/kullanicilar`,icon:<UsersRound />},
    {title:'Teklifler',link:`/admin/teklifler`,icon:<LayoutGrid />},
    {title:'İlanlar',link:`/admin/ilanlar`,icon:<Grid2x2Plus />},
    {title:'Görüşmeler',link:`/admin/mesajlar`,icon:<MessageSquare />},
    {title:'Öne Çıkanlar',link:`/admin/onecikan`,icon:<TrendingUp />},
    {title:'İletişim',link:`/admin/iletisim`,icon:<MessageCircleQuestion />},
  ]
