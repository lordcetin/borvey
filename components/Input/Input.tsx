...
const Input: React.FC<InputProps> = ({id,onChange,name,value,label,type = "text",onError,errorMessage=""}) => {
  ...
  return (
      ...
      onChange={onChange}
      className={onError 
      ? "peer valid:pt-4 transition-all ease-linear w-full dark:bg-[#15171B] appearance-none bg-white my-2 py-2 px-4 rounded-lg dark:text-red-900 text-red-500 dark:placeholder:text-red-900 placeholder:text-red-500 outline-hidden active:border-2 active:border-blue-500 focus:border-blue-500 border-2 dark:border-red-800 border-red-500 hover:border-2 hover:border-blue-500 " 
      : "peer valid:pt-4 transition-all ease-linear w-full dark:bg-[#15171B] appearance-none bg-white my-2 py-2 px-4 rounded-lg text-neutral-600 dark:text-white placeholder:text-slate-600 outline-hidden active:border-2 active:border-blue-500 focus:border-blue-500 border dark:border-white/30 border-black/30 hover:border-2 hover:border-amber-500 "
      }/>
